...
| `MAX_STEPS` | Model calls per challenge slice, integer 1–150; packaged default 16 |
| `MAX_TOOL_CALLS`, `MAX_SUBMISSIONS` | Local per-slice tool/submission bounds; packaged defaults 20/3 |
